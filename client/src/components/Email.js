...
const Email = ({ setEmailForm }) => {
  ...
  return (
    <form className="email" ref={emailRef} onSubmit={sendEmail} onClick={() => {setEmailForm(false)}}>
      <div className='email_inputs grid'>
      ...
      <div className='email_content_message'>
        ...
        <textarea className='email_input' name='user_message'/>
      </div>
